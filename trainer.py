...
def train_rsgnn(flags, graph, rng, init, centers_initialized):
    ...
    #rng = new_rng
    model = rsgnn_models.RSGNN(nfeat=features.shape[1], hid_dim=flags.hid_dim, num_reps=flags.num_reps, init=init, centers_initialized=centers_initialized)
