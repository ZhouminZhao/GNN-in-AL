...
def representation_selection(subset, select, init, bce_loss):
    ...
    centers, selected = trainer.train_rsgnn(rsgnn_flags, graph, key, init, bce_loss)  # 使用rsgnn并获取learned embeddings和选定的节点
