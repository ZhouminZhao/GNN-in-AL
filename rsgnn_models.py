...
class RSGNN(nn.Module):
    ...
    def __init__(self, nfeat, hid_dim, num_reps, init, centers_initialized):
        super(RSGNN, self).__init__()
        self.num_reps = num_reps
        self.dgi = DGI(nfeat)
        self.cluster = Cluster(num_reps, init, centers_initialized)
...
class Cluster(nn.Module):
    ...
    def __init__(self, num_reps, init, centers_initialized):
        super(Cluster, self).__init__()
        self.num_reps = num_reps
        self.cluster = layers.EucCluster(num_reps=num_reps, init_fn=nn.init.normal_, init=init, centers_initialized=centers_initialized)
