...
def representation_selection(subset, select, init, centers_initialized):
    ...
    centers, selected = trainer.train_rsgnn(rsgnn_flags, graph, key, init, centers_initialized)  # 使用rsgnn并获取learned embeddings和选定的节点
